...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{E1//Immagini/Take Off Parameter.png}
...
Gli ipersostentatori aumentano il coefficiente di resistenza:
...
La velocità $V_2$ è quella caratteristica del decollo, in questa fase posta pari a 1.2 volte la velocità di stallo.

\noindent Infine, l'equazione per il rapporto di spinta è ricavata dalla meccanica del volo:

W4_W3 = exp(-(SFC_cruise*range)/(v_cruise*mps2kmph*E_curr)); %cruise
Wloiter1 = exp(-(SFC_loiter*loiter1)/(E_curr/0.866)); %loiter1
W8_W7 = exp(-(SFC_cruise*diversione)/(v_cruise*mps2kmph*E_curr)); %diversion
...
W_block_fuel = (1-(W2_WTO*W3_W2*W4_W3*W5_W4)) * WTO_curr;
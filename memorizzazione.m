...
if W_S_des <= wing_load_max && b_ref <= 36
    ...
    oswald_memo(indice_contatore) = oswald;
    T_curr_memo(indice_contatore) = T_curr;
    thrust_ratio_memo(indice_contatore) = thrust_ratio_des;

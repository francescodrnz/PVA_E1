...
S_wet_memo = NaN(num_configurazioni, 1);
b_ref_memo = NaN(num_configurazioni, 1);
croot_memo = NaN(num_configurazioni, 1);
ctip_memo = NaN(num_configurazioni, 1);
MAC_memo = NaN(num_configurazioni, 1);
S_vert_memo = NaN(num_configurazioni, 1);
S_orizz_memo = NaN(num_configurazioni, 1);
CL_des_memo = NaN(num_configurazioni, 1);
CL_max_memo = NaN(num_configurazioni, 1);
CD_curr_memo = NaN(num_configurazioni, 1);
Cd0_memo = NaN(num_configurazioni, 1);
Cdi_memo = NaN(num_configurazioni, 1);
Cdw_memo = NaN(num_configurazioni, 1);
E_curr_memo = NaN(num_configurazioni, 1);
oswald_memo = NaN(num_configurazioni, 1);
T_curr_memo = NaN(num_configurazioni, 1);
thrust_ratio_memo = NaN(num_configurazioni, 1);
